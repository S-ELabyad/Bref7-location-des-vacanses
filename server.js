...
const _PORT = 3003;
const _FUNCS = require('./tous/model/dataStorage');
// 
...
_APP.get('/', (req, res) => {
    res.sendFile(_PATH.join(__dirname, 'tous/html/gallerie.html'));
});
_APP.get('/connexion', (req, res) => {
    res.sendFile(_PATH.join(__dirname, 'tous/html/connexion.html'));
});
_APP.get('/carnet', (req, res) => {
    res.sendFile(_PATH.join(__dirname, 'tous/html/carnet.html'));
});
_APP.get('/inscription', (req, res) => {
    res.sendFile(_PATH.join(__dirname, 'tous/html/inscription.html'));
});
_APP.get('/reservation', (req, res) => {
    res.sendFile(_PATH.join(__dirname, 'tous/html/reservation.html'));
});
...
_APP.use('/', _EXPRESS.static(_PATH.join(__dirname, 'tous')));
// START THE SERVER
_APP.listen(_PORT, () => {
